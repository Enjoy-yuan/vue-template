...
const routes = [
    ...
    { path: '*', name: 'NotFound', component: () => import(/* webpackChunkName: "NotFound" */ '@/views/Error') },
    {
        ...
        children: [
            ...
            { path: '/three/one', name: 'One', component: () => import(/* webpackChunkName: "One" */ '@/views/Three/One') },
            ...
            { path: '/three/car', name: 'Car', component: () => import(/* webpackChunkName: "Car" */ '@/views/Three/Car') },
            {
                path: '/three/feature',
                name: 'Feature',
                component: () => import(/* webpackChunkName: "Feature" */ '@/views/Three/Feature')
            },
            { path: '/three/sprite', name: 'Sprite', component: () => import(/* webpackChunkName: "Sprite" */ '@/views/Three/Sprite') },
            {
                path: '/three/panoramic',
                name: 'Panoramic',
                component: () => import(/* webpackChunkName: "Panoramic" */ '@/views/Three/Panoramic')
            },
            {
                path: '/stock/beijingchaojia',
                name: 'Beijingchaojia',
                component: () => import(/* webpackChunkName: "Beijingchaojia" */ '@/views/Stock/Beijingchaojia')
            },
            {
                path: '/echarts/bar',
                name: 'Bar',
