<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404" style="width: 1000px;">
      <div class="pic-404">
      ...
      <div class="bullshit">
        <div class="bullshit__oops" style="color:#67c23a;">OOPS!</div>
        <div class="bullshit__headline">{{ message }}</div>
        <div class="bullshit__info">
          Please check that the URL you entered is correct, or click the button below to return to the homepage.
        </div>
        <router-link to="/home"><el-button type="primary" round> Back to Home</el-button></router-link>
      </div>
    </div>
  </div>
</template>
